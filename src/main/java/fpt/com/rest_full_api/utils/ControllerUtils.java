package fpt.com.rest_full_api.utils;

import fpt.com.rest_full_api.request.SearchRequest;
import fpt.com.rest_full_api.response.MessageResponse;
...
public class ControllerUtils {
    ...
    public boolean validateInputField(Model model, MessageResponse messageResponse, String attributeKey,
    ...
    public boolean validateInputFields(BindingResult bindingResult, Model model, String attributeKey,
            Object attributeValue) {
    ...
    public String setAlertFlashMessage(RedirectAttributes redirectAttributes, String page,
    ...
    private int[] computePagination(Page<?> page) {
        ...
        if (totalPages > 7) {
            ...
            Integer[] tail = pageNumber < (totalPages - 3) ? new Integer[] { -1, totalPages }
            ...
            Collections.addAll(list,
                    (pageNumber > 3 && pageNumber < totalPages - 2) ? new Integer[] { pageNumber } : new Integer[] {});
